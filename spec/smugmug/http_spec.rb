...
describe SmugMug::HTTP do
  ...
  it "generates a correct HMAC-SHA1 digest" do
    Time.stub(:now).and_return(Time.new(2012, 7, 6, 10, 5))
    ...
    postdata.should == "a=Foo+%26+Bar&b=5&c=Foo%0ABar&method=smugmug.foo.bar&oauth_consumer_key=1234-api&oauth_nonce=3858f62230ac3c915f300c664312c63f&oauth_signature_method=HMAC-SHA1&oauth_timestamp=1341594300&oauth_token=abcd-token&oauth_version=1.0&oauth_signature=XAf8Fo%2FOc9tnbAhxrJBmer%2FSudo%3D"
  end
end